      ...
      <div className="dashboard-page">
        ...
        <main className="dashboard-main">
          <div className="verify-prompt">
            ...
            <p>Please check your inbox and click the verification link to unlock Analysis.</p>
      ...
      <main className="analysis-main">
        {loading ? (
          <div className="dashboard-loading">
            ...
            <p>Loading the analysis workspace...</p>
          </div>
        ) : (
          <>
              ...
              {!trackRecord?.available || !trackRecord.summary ? (
                ...
                <>
                  ...
                  <div className="track-record-context">
                    Average trade return is quoted per closed trade after costs. Compounding across{' '}
                ...
                <div className="selected-stocks">
                  ...
                  <div className="selected-list">
                    {selectedStocks.length === 0 ? (
                      <span className="placeholder">No tickers selected yet</span>
                    ) : (
              ...
              <section className="card config-panel">
                ...
                <form className="config-form">
                  ...
                  <div className="config-row">
                    ...
                    <span className="form-hint">Horizon is locked to the selected model.</span>
                  </div>
                  ...
                  >
                    {analyzing ? 'Analyzing...' : 'Run Board Scan'}
                  </button>
                </form>
              </section>
            </div>
            ...
            <section className="card results-panel">
                ...
                <div className="results-header-actions">
                  ...
                  {canExportCsv && (
                    <button
                      ...
                      title={!canExportNow ? 'Run a board scan to enable CSV export' : undefined}
                    >
                      Export CSV
                    </button>
                  )}
              ...
              {canExportCsv && !canExportNow && (
                <p className="form-hint">CSV export becomes available after you run a board scan.</p>
              )}
              {!canExportCsv && (
              ...
              {!results ? (
                <div className="results-empty">
                  <p>Select tickers and run a board scan to see results.</p>
                </div>
              ) : (
